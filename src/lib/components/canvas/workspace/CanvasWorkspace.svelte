<script lang="ts">
  ...
  import DiagramToolbar from '$lib/components/canvas/workspace/toolbars/DiagramToolbar.svelte'
  import DrawingToolbar from '$lib/components/canvas/workspace/toolbars/DrawingToolbar.svelte'
