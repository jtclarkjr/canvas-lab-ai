...
<Dialog
  ...
  class="flex max-h-[min(32rem,calc(100dvh-2rem))] flex-col overflow-hidden rounded-2xl bg-card/95 p-0 text-card-foreground backdrop-blur-xl sm:rounded-[1.75rem]"
