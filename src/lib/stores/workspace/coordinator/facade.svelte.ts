...
export function createWorkspaceFacade({
  ...
  return {
    ...
    setDrawWidth: stores.sceneStore.setDrawWidth,
    setDrawColor: stores.sceneStore.setDrawColor,
    setDrawStyle: stores.sceneStore.setDrawStyle,
    toggleHighlighter: stores.sceneStore.toggleHighlighter,
    setHighlighterOpacity: stores.sceneStore.setHighlighterOpacity,
