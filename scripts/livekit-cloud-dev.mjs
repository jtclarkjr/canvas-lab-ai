...
console.log(
  '[livekit] using LIVEKIT_URL, LIVEKIT_API_KEY, and LIVEKIT_API_SECRET from .env'
)
start('app', 'vp', ['dev', '--host', '127.0.0.1'])
start('transcriber', '/bin/sh', [
  '-c',
  'vp run agent:build && node dist-agent/canvas-transcriber.js dev'
])
